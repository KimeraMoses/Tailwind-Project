...
const DashBoardSideBar: React.FunctionComponent = () => {
  ...
  return (
    <div className="hidden min-w-sideBar xl:min-w-largeSideBar sticky pb-4 md:flex flex-col  justify-between top-navbarsOffset bg-primary text-white  h-sideBarHeight  ">
